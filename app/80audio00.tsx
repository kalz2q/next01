...
export default function Home() {
  ...
  const initialData: MusicData[] = [
    {
      ...
      mp3Url: "https://lh3.google.com/u/0/d/1877DcOpz7rhRQ7XhpV7I34MQf018IDYt",
      title: "水戸黄門(じんせいらくありゃくもあるさ)",
      filename: "mitokomon.pdf",
    },
    {
      jpgUrl: "https://lh3.google.com/u/0/d/1uCHqo0azmYAlA_uXPSbIDqONPcCCsktO",
      mp3Url: "https://lh3.google.com/u/0/d/1uz6hK-iGgWwpW3o09bLO9ZRg8AQ3NVxC",
    ...
    },
    {
      ...
      mp3Url: "https://lh3.google.com/u/0/d/1Mz6hlYoD-PUHQRuGVl1DDm3128sIIIKV",
      title:
  ...
  const handleSubmit = () => {
    ...
    const selectedMusic = initialData[randomIndex];
    setModel((prevModel) => ({
      ...prevModel,
    ...
    <div style={{ margin: "auto", width: "800px" }}>
      {model.dolist ? (
        ...
        <div>
          <div>
            {/* <h1>
              <audio src={model.mp3Url} controls style={{ float: "right" }} />
            </h1> */}
            <audio controls>
              {/* <source src="https://drive.google.com/file/d/YourFileID/preview" type="audio/mp3" /> */}
              <source
                src="https://drive.google.com/file/d/1877DcOpz7rhRQ7XhpV7I34MQf018IDYt/preview"
                type="audio/mp3"
              />
